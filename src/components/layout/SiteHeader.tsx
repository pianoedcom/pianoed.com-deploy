      ...
      <div className="mx-auto flex h-20 w-full items-center justify-between px-4 sm:px-8">
        ...
        <div className="hidden items-center gap-2 md:flex">
          {headerCta && (
            <Link
              to={headerCta.href}
              className="mr-2 inline-flex items-center justify-center rounded-md border border-[#d4af37]/80 bg-[#1e0507]/90 px-4 py-2 text-xs sm:text-sm font-medium text-[#fcefd2] shadow-[0_2px_6px_rgba(0,0,0,0.6)] backdrop-blur-sm transition-all hover:bg-[#340b0e] hover:border-[#f5d97d] hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d4af37]"
            >
              {headerCta.label}
            </Link>
          )}

          <div className="flex items-center gap-1 text-[#f5ecd7]">
            <SearchButton />
            <Link
              to="/about"
              className="rounded-full p-2 text-[#f5ecd7] hover:text-[#d4af37] hover:bg-white/10 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d4af37]"
