...
interface SheetMusicDifficultyBadgeProps {
...
export const SheetMusicDifficultyBadge: React.FC<SheetMusicDifficultyBadgeProps> = ({
  difficulty,
  className = "",
}) => {
...
export default SheetMusicDifficultyBadge;
